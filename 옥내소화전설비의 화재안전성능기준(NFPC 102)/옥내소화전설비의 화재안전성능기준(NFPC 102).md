...
### 제2조(적용범위)
이 기준은「소방시설 설치 및 관리에 관한 법률 시행령」(이하 "영"이라 한다) 별표 4 제1호다목에 따른 옥내소화전설비의 설치 및 관리에 대해 적용한다.
